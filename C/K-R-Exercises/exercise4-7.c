...
//
// NOTES:
// - Had to turn to the internet for help on this one.
// - I don't understand the purpose of ungets. What is the
// calculator meant to do with a string?  My guess is the
// the author's intent was just to implement this as an
// interesting exercise.  Hopefully I'm not ignoring any
// major functionality.
// - ungets doesn't need to know about the buffer because
// the way it is implemented here, ungets uses ungetch which
// handles the buffer.
// -----------------------------------------------------------
